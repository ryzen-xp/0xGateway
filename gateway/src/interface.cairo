...
pub trait IGateway<TContractState> {
    ...
    fn remove_wallet(ref self: TContractState, chain_symbol: felt252);
    ...
    fn get_wallet(self: @TContractState, username: ByteArray, chain_symbol: felt252) -> Wallet;
    fn get_user_chain_symbols(self: @TContractState, username: ByteArray) -> Array<felt252>;
